# Content Calendar — The Northwoods Journal (Pine & Dandy)

Local-guide backlog for the Mon/Wed/Fri SEO + AI-search cadence. Each targets a real
"things to do near Eagle River / Northwoods travel" search intent — the content that
wins vacation-rental bookings. Warm first-person host voice ("we," "your hosts").

| # | Status | Working title | Target intent / keyword |
|---|--------|---------------|--------------------------|
...
| 7 | ✅ Published | Rainy-day activities near Eagle River for families | "things to do eagle river rain", "eagle river with kids" |
...
| 28 | ✅ Published | Fall fishing near Eagle River: the autumn bite on the Northwoods lakes | "fall fishing eagle river wi", "autumn musky fishing wisconsin", "fall walleye northwoods" |

## Notes
- 600–900 words, warm and genuinely useful — written like advice from a host, not an ad.
- Always: target keyword in title + first paragraph; a 3-question FAQ block (drives the
  FAQPage schema + AI citations); internal links to the cabins (/the-og.html,
  /the-grandy-dandy.html) and a relevant guide (/area-guide.html, /dining.html,
  /fishing.html); and a "where to stay" callout CTA.
- Keep facts safe/evergreen (seasons, general locations). Don't invent specific dates,
  prices, or business hours — phrase timing generally ("each January," "mid-October").
